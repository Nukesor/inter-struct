...
mod tests {
    ...
    /// Test the normal [StructMerge::merge_ref_soft] function for a struct with the exact same structure.
    #[test]
    ...
    /// Test the normal [StructMerge::merge_ref_soft] function for a similar struct, but all fields are
    /// optional.
    #[test]
    ...
    /// Test the normal [StructMerge::merge_ref_soft] function for a similar struct, but some fields are
    /// optional and some are identical.
    #[test]
    fn merge_soft_mixed() {
        // The base struct that's going to be merged into.
